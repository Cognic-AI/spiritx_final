...
class _SportFinderScreenState extends State<SportFinderScreen> {
  ...
  final List<Map<String, dynamic>> _questions = [
    ...
    {
      'section': 'Endurance',
      'label': 'How long can you jog continuously without rest? (minutes)',
      'key': 'jog_duration',
      'min': 5,
      'max': 120,
      'default': 60,
    ...
    {
      'section': 'Endurance',
      'label': 'How many kilometers can you run in one go? (km)',
      'key': 'run_distance',
      'min': 1,
      'max': 25,
      'default': 10,
    ...
    {
      'section': 'Endurance',
      'label': 'How long can you sustain moderate cycling? (minutes)',
      'key': 'cycling_duration',
      'min': 10,
      'max': 180,
      'default': 60,
      'weight': 0.20
    ...
    {
      'section': 'Endurance',
      'label': 'How many laps can you swim without resting? (laps)',
      'key': 'swim_laps',
      'min': 1,
      'max': 40,
      'default': 10,
    ...
    {
      'section': 'Endurance',
      'label': 'How quickly do you recover after long cardio? (minutes)',
      'key': 'cardio_recovery',
      'min': 2,
      'max': 30,
      'default': 10,
    ...
    {
      'section': 'Strength',
      'label': 'How many push-ups can you do in one minute? (count)',
      'key': 'pushups',
      'min': 5,
      'max': 60,
      'default': 30,
    ...
    {
      'section': 'Strength',
      'label': 'What is your deadlift compared to body weight? (ratio ×100)',
      'key': 'deadlift_ratio',
      'min': 50,
      'max': 250,
      'default': 125,
    ...
    {
      'section': 'Strength',
      'label': 'How many squats can you do in one minute? (count)',
      'key': 'squats',
      'min': 10,
      'max': 70,
      'default': 30,
    ...
    {
      'section': 'Strength',
      'label': 'How much weight can you press overhead with one arm? (kg)',
      'key': 'overhead_press',
      'min': 5,
      'max': 50,
      'default': 20,
    ...
    {
      'section': 'Strength',
      'label': 'How long can you hold a plank? (seconds)',
      'key': 'plank_hold',
      'min': 10,
      'max': 300,
      'default': 120,
    ...
    {
      'section': 'Power',
      'label': 'What is your standing vertical jump? (cm)',
      'key': 'vertical_jump',
      'min': 10,
      'max': 80,
      'default': 40,
    ...
    {
      'section': 'Power',
      'label': 'What is your standing long jump? (cm)',
      'key': 'long_jump',
      'min': 100,
      'max': 300,
      'default': 180,
    ...
    {
      'section': 'Power',
      'label': 'How fast can you throw a 3kg medicine ball? (m/s)',
      'key': 'ball_throw_speed',
      'min': 5,
      'max': 20,
      'default': 10,
      'weight': 0.20
    ...
    {
      'section': 'Power',
      'label': 'How many clap push-ups can you do in a row? (count)',
      'key': 'clap_pushups',
      'min': 1,
      'max': 25,
      'default': 10,
    ...
    {
      'section': 'Power',
      'label': 'How high can you jump from a squat position? (cm)',
      'key': 'squat_jump',
      'min': 10,
      'max': 60,
      'default': 30,
    ...
    {
      'section': 'Speed',
      'label': 'What is your 40m sprint time? (seconds)',
      'key': 'sprint_40m',
      'min': 4,
      'max': 10,
      'default': 7,
    ...
    {
      'section': 'Speed',
      'label': 'How fast can you run 100m? (seconds)',
      'key': 'sprint_100m',
      'min': 10,
      'max': 20,
      'default': 15,
    ...
    {
      'section': 'Speed',
      'label': 'How fast is your shuttle run (5×10m)? (seconds)',
      'key': 'shuttle_run',
      'min': 8,
      'max': 20,
      'default': 14,
    ...
    {
      'section': 'Speed',
      'label': 'How quick are your reaction times? (ms)',
      'key': 'reaction_time',
      'min': 150,
      'max': 400,
      'default': 250,
    ...
    {
      'section': 'Speed',
      'label': 'How many cone touches can you do in 20 seconds? (count)',
      'key': 'cone_touches',
      'min': 5,
      'max': 25,
      'default': 12,
    ...
    {
      'section': 'Agility',
      'label': 'How quickly can you complete an agility ladder? (seconds)',
      'key': 'ladder_time',
      'min': 5,
      'max': 20,
      'default': 10,
    ...
    {
      'section': 'Agility',
      'label': 'How fast can you zig-zag through cones? (seconds)',
      'key': 'zigzag_cones',
      'min': 6,
      'max': 20,
      'default': 12,
    ...
    {
      'section': 'Agility',
      'label': 'How many direction changes in 30 seconds? (count)',
    ...
    {
      'section': 'Agility',
      'label': 'How fast can you perform T-test drill? (seconds)',
      'key': 't_test_time',
      'min': 6,
      'max': 14,
      'default': 10,
    ...
    {
      'section': 'Agility',
      'label': 'How long to complete a figure-8 drill? (seconds)',
      'key': 'figure8_time',
      'min': 5,
      'max': 20,
      'default': 12,
    ...
    {
      'section': 'Flexibility',
      'label': 'How far can you reach past your toes? (cm)',
      'key': 'toe_reach',
      'min': -10,
      'max': 30,
      'default': 5,
    ...
    {
      'section': 'Flexibility',
      'label': 'What is your shoulder flexibility range? (cm)',
      'key': 'shoulder_reach',
      'min': 10,
      'max': 50,
      'default': 30,
    ...
    {
      'section': 'Flexibility',
      'label': 'How far can you spread your legs (split)? (degrees)',
      'key': 'leg_split',
      'min': 30,
      'max': 180,
      'default': 90,
    ...
    {
      'section': 'Flexibility',
      'label': 'Can you touch the ground with straight legs? (cm)',
      'key': 'forward_bend',
      'min': -20,
      'max': 20,
      'default': 0,
    ...
    {
      'section': 'Flexibility',
      'label': 'How flexible is your spine when bending back? (degrees)',
      'key': 'spine_bend',
      'min': 10,
      'max': 60,
      'default': 30,
    ...
    // Nervous System
    {
      'section': 'Nervous system requirements',
      'label': 'What is your average reaction time on a click test? (ms)',
      'key': 'click_reaction',
      'min': 150,
      'max': 350,
      'default': 220,
    ...
    {
      'section': 'Nervous system requirements',
      'label': 'How many quick taps can you do in 10 seconds? (count)',
      'key': 'taps_10s',
      'min': 20,
      'max': 80,
      'default': 40,
    ...
    {
      'section': 'Nervous system requirements',
      'label': 'How fast can you identify changing colors? (corrects/30s)',
      'key': 'color_response',
      'min': 5,
      'max': 20,
      'default': 10,
    ...
    {
      'section': 'Nervous system requirements',
      'label': 'How accurate is your hand-eye coordination? (% correct)',
      'key': 'coordination',
      'min': 50,
      'max': 100,
      'default': 75,
    ...
    {
      'section': 'Nervous system requirements',
      'label': 'How fast can you repeat a pattern sequence? (seconds)',
      'key': 'pattern_time',
      'min': 5,
      'max': 25,
      'default': 12,
    ...
    {
      'section': 'Durability',
      'label': 'How often do you get injured during training? (times/year)',
      'key': 'injuries',
      'min': 0,
      'max': 10,
      'default': 2,
    ...
    {
      'section': 'Durability',
      'label': 'How long does it take you to recover from strain? (days)',
      'key': 'strain_recovery',
      'min': 1,
      'max': 14,
      'default': 5,
    ...
    {
      'section': 'Durability',
      'label': 'How often can you train intensely per week? (sessions)',
      'key': 'intense_sessions',
      'min': 1,
      'max': 14,
      'default': 5,
      'weight': 0.20
    ...
    {
      'section': 'Durability',
      'label': 'How many rest days do you need weekly? (days)',
      'key': 'rest_days',
      'min': 0,
      'max': 7,
      'default': 2,
    ...
    {
      'section': 'Durability',
      'label': 'How long can you keep up hard training? (weeks)',
      'key': 'training_streak',
      'min': 1,
      'max': 16,
      'default': 8,
    ...
    {
      'section': 'Handling',
      'label': 'How well do you control a ball with your foot? (1–10)',
      'key': 'foot_control',
      'min': 1,
      'max': 10,
      'default': 5,
    ...
    {
      'section': 'Handling',
      'label': 'How well do you control a ball with your hands? (1–10)',
      'key': 'hand_control',
      'min': 1,
      'max': 10,
      'default': 5,
    ...
    {
      'section': 'Handling',
      'label': 'How many successful catches out of 10? (count)',
      'key': 'catch_accuracy',
      'min': 0,
      'max': 10,
      'default': 7,
    ...
    {
      'section': 'Handling',
      'label': 'How accurately can you throw at a target? (% hits)',
      'key': 'throw_accuracy',
      'min': 0,
      'max': 100,
      'default': 60,
    ...
    {
      'section': 'Handling',
      'label': 'How well do you control a bat, stick, or racquet? (1–10)',
      'key': 'tool_handling',
      'min': 1,
      'max': 10,
      'default': 5,
  ...
  Future<void> _findSports() async {
    ...
    Map<String, List<double>> sectionValues = {
      'Endurance': [],
      'Strength': [],
      'Power': [],
      'Speed': [],
    ...
    // Collect normalized values for each section
    for (var question in _questions) {
      ...
      // Min-max normalization to get value between 0 and 1
  ...
  Widget _buildResultsView() {
    return Column(
      children: [
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'Based on your responses, these sports match your physical attributes and preferences.',
                style: TextStyle(
                  color: Theme.of(context).textTheme.bodyMedium?.color,
                ),
              ),
        ...
        Expanded(
          child: _recommendedSports!.isEmpty
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 8),
                                Text(
                                  recommendation.sport.description,
                                  style: TextStyle(
                                ...
                                Wrap(
                                  ...
                                  runSpacing: 8,
                                  children:
                                      recommendation.sport.skills.map((skill) {
                                    return Container(
                                      padding: const EdgeInsets.symmetric(
                                        horizontal: 10,
                                        vertical: 4,
